...
describe "Campaigns", type: :request do
  ...
  describe "#update" do
    context "given valid params" do
      ...
      it "responds 200 OK" do
        post '/message', type: 'update_campaign', name: 'AKProcessor test: Updated campaign', campaign_id: 1234
        expect(response.code).to eq "200"
    ...
    context "given invalid params" do
      ...
      it "responds 500 Internal Server Error" do
        VCR.use_cassette "update_multilingual_campaign_400" do
          post '/message', type: 'update_campaign', name: '', campaign_id: 1234 #blank name
        end
        expect(response.code).to eq "500"
      end
    end
